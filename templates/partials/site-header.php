  ...
  <div class="c-site-head__inner o-row o-row--expanded">
    ...
    <nav class="c-site-head__right">
      <ul class="c-site-head__menu">
        <li>
          <a href="/training" class="js-site-link <?php echo $current_page == 'training.php' ? 'is-active' : NULL ?>">Training</a>
        </li>
        <li>
...
<aside class="c-site-nav | js-site-nav">
  <div class="c-site-nav__inner | js-site-nav__inner">
    ...
    <a href="/" class="c-site-nav__logo js-site-link">
      <img src="/static/logo.png" alt="56k">
    </a>
    <ul>
      <li>
        <a href="/" class="c-site-nav__link | js-site-nav__link <?php echo $current_page == 'index.php' ? 'is-active' : NULL ?>">Home</a>
      </li>
      <li>
        <a href="/training" class="c-site-nav__link | js-site-nav__link <?php echo $current_page == 'training.php' ? 'is-active' : NULL ?>">Training</a>
      </li>
      <li>
